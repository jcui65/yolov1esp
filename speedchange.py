...
for shouldbeold in ['t4']:#['n11','n12','n13','n14']:#,['t421','t422','t423','t431','t432','t433','t441','t442','443']:#['t411','t412','t413']:#,[,'t419','t421','t424','t431','t434']:
    for file in dirs:
        #print(file)
        #print('the folder is loaded!')
        usedtobe1='CreateKeyFrame(time2+timeshift);'#"float timefactor=10.0;"
        shouldbe1='CreateKeyFrame(time2+timeshift+0.2*timefactor);'
        usedtobe2 = 'CreateKeyFrame(time3+timeshift);'  # "float timefactor=10.0;"
        shouldbe2 = 'CreateKeyFrame(time3+timeshift-0.2*timefactor);'
        if shouldbeold in file:
            ...
            newdata1 = filedata.replace(usedtobe1, shouldbe1)
