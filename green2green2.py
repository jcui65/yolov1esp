...
for newshouldbe in ['n11','n12','n13','n14']:#['t411','t412','t413','t421','t422','t423','t431','t432','t433','t441','t442','t443']:#['t411','t412','t413','t416','t419','t424',,'t434']:
    #oldreal = 'real'
    ...
    for file in dirs:
        ...
        if newshouldbe in file:
            ...
            for j in ['/model.config','/model.sdf']:
                ...
                newdata2=filedata.replace(file2+file3,file2+sfile3)
                ...
                filedir=path+file1+file2+sfile3
